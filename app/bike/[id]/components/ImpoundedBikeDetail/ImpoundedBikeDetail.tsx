...
const ImpoundedBikeDetail = ({ bike }: Props) => {
  const {
    status,
    manufacturer,
    model,
  ...
  return (
    <>
      <h1>
        <strong className="text-red-500">Impounded</strong> {title}
      </h1>
      <p className="text-orange-300">
        <strong>Looking for the correct owner of this bike!</strong>
      </p>
      <p className="mb-4">
        <strong>Impounded in</strong> {locationFound}
      </p>
...
export default ImpoundedBikeDetail;
